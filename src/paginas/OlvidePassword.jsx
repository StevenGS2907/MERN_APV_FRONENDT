  ...
  return (
    ...
    <div>
      <h1 className="text-indigo-600 font-black text-6xl">
          ...
          <span className="text-black">tus Pasientes</span>
      </h1>
    </div>
    ...
    />}
        ...
        >
          <div className="my-5">
            ...
            <input type="email" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" placeholder="Escribe tu Email"
             value={email}
        ...
        <nav className="mt-10 lg:flex lg:justify-between">
                <Link 
                    ...
                    to="/">¿Ya tienes Cuenta? Inicia Sesion</Link>
                <Link
                    className='block text-center my-5 text-gray-500' 
